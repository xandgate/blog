# The 5-Minute Code Review: How I Evaluate AI-Generated Code Without Getting Burned
**A mental model for quickly spotting problems in AI output**


- **Slug:** `five-minute-code-review`
...
When AI generates code, you need to review it fast—but not so fast you miss critical issues. Here's my checklist for evaluating AI output in minutes, not hours.
