# My AI Coding Stack: Claude, Cursor, and the Art of Knowing When to Intervene
**The tools I actually use, the prompts that work, and when to take the wheel**


- **Slug:** `my-ai-coding-stack`
...
After months of experimenting with AI coding assistants, here's my actual workflow with Claude and Cursor—including real prompts that consistently produce good results.
